...
async def start_cmd(client, message):
    ...
    await message.reply_photo(
        ...
        reply_markup=types.InlineKeyboardMarkup([
            [types.InlineKeyboardButton("📢 Main Channel", url="https://t.me/AkMovieVerse")],
            [types.InlineKeyboardButton("🖼️ Wallpaper", url="https://t.me/Rkn_Bots_Support")],
            [types.InlineKeyboardButton("🔥 Adult Channel", url="https://t.me/PurelySin")]
        ])
    )
